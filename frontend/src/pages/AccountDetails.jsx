...
export default function AccountDetails() {
  ...
  if (loading) return (
    <div className="page"><div className="spinner-wrap">Loading account…</div></div>
  );
        ...
        {account && (
          <>
            ...
            <div className="detail-row">
              ...
              <span className="detail-row__value">{account.user_name}</span>
            </div>
            <div className="detail-row">
            ...
            <div className="detail-row">
              ...
              <span className="detail-row__value">{account.account_type}</span>
            </div>
            <div className="detail-row">
